...
GLOSSARY_FILE = BASEDIR+"/synonym/hownet/glossary.txt"
SEMEME_FILE = BASEDIR+"/synonym/hownet/WHOLE.DAT"
...
class HownetSim:
    ...
    def __init__(self):
        ...
        self.glossaryfile = GLOSSARY_FILE
        self.sememefile = SEMEME_FILE
        self.vocab = set()
